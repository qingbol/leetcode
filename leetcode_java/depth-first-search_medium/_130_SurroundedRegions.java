...
class Solution {
  ...
  private void dfs1(char[][] board, int r, int c) {
  ...
  // 59/59 cases passed (10 ms)
  // Your runtime beats 8.52 % of java submissions
  // Your memory usage beats 72.88 % of java submissions (41 MB)
